...
public class CuentaListado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblCuenta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cuenta", "Cliente", "Direccion", "Telefono", "Email"
            }
        ));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        List<Cliente> clientes = ClienteDAO.obtenerTodosc();
        DefaultTableModel modelo = 
        (DefaultTableModel)tblCuenta.getModel();
        modelo.setRowCount(0);        
        for(Cliente c : clientes ){
            modelo.addRow(new Object[] {c.getNombre(),c.getDireccion(),c.getTelefono(),c.getEmail(),c.getCuenta()});
        }
